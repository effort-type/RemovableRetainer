					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<div class="table-responsive">
								<form mehod="post"	action="../Back-End/publicFaq.jsp">
									<label>제목</label>
									<input type="text" class="table table-bordered" width="100%" id="header" name="header" required>
									<label>내용</label>
									<textarea style="resize: none; width: 100%; height: 100%;" required id="text" name="text"></textarea>
